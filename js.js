...
document.head.insertBefore(meta_charset, container.head.body.firstChild);

var meta_viewport = document.createElement('meta');
meta_viewport.name = "viewport";
meta_viewport.content = "width=device-width, initial-scale=1.0";
document.head.insertBefore(meta_viewport, container.head.body.firstChild);

var link_style = document.createElement('link');
link_style.rel = "stylesheet";
link_style.type = "text/css";
link_style.href = "/style.css";
document.head.insertBefore(link_style, container.head.body.firstChild);
...
document.head.insertBefore(link_icon, container.head.body.firstChild);
