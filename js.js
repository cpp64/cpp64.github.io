...
document.head.insertBefore(meta_charset, container.body.firstChild);

var meta_viewport = document.createElement('meta');
meta_viewport.name = "viewport";
meta_viewport.content = "width=device-width, initial-scale=1.0";
document.head.insertBefore(meta_viewport, container.body.firstChild);

var link_style = document.createElement('link');
link_style.rel = "stylesheet";
link_style.type = "text/css";
link_style.href = "/style.css";
document.head.insertBefore(link_style, container.body.firstChild);
...
document.head.insertBefore(link_icon, container.body.firstChild);

var div_navigation = document.createElement('div');
div_navigation.id = "navigation";
div_navigation.class = "navigation";
document.head.insertBefore(div_navigation, container.body.firstChild);
$(function () {
